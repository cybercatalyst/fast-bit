...
**
** Created: Sun Mar 6 16:40:51 2011
...
static const char qt_meta_stringdata_Graph[] = {
    "Graph\0\0index\0clearRenderer(int)\0image\0"
    "updateStatistics(QImage)\0changeLanguage()\0"
};

const QMetaObject Graph::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_Graph,
...
int Graph::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: clearRenderer((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: updateStatistics((*reinterpret_cast< QImage(*)>(_a[1]))); break;
